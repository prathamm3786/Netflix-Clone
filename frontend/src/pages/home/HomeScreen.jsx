  ...
  return (
    <>
      <div className='relative h-screen text-white  '>
        <Navbar />
        {/* Loading shimmer effect for the image */}
        {imgloading && (
          <div className='absolute top-0 left-0 w-full h-full bg-black/70 flex items-center justify-center -z-10 shimmer ' />
        )}
        <img src={"https://image.tmdb.org/t/p/original"+ trendingContent?.backdrop_path} alt='hero img' className='absolute top-0 left-0 w-full h-full object-cover -z-50' onLoad={() => setImgLoading(false)} />
